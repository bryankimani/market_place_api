...
class Api::V1::OrdersControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should show orders' do
    get api_v1_orders_path, headers: { Authorization: JsonWebToken.encode(user_id: @order.user_id) }, as: :json
  ...
  test 'should show order' do
    get api_v1_order_path(@order), headers: { Authorization: JsonWebToken.encode(user_id: @order.user_id) }, as: :json
    assert_response :success
